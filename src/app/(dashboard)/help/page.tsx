...
const faqs = [
  ...
  {
    question: "หน่วยกิตการศึกษาต่อเนื่อง (CPE) ไม่ขึ้นในระบบ",
    answer: "หากเป็นกิจกรรมที่จัดโดยองค์กรภายนอก อาจใช้เวลา 7-14 วันในการอัปเดตข้อมูลเข้าสู่ฐานข้อมูลกลางของสภาฯ คุณสามารถกดปุ่ม 'ซิงค์ข้อมูลกับ ศธภ.' ที่หน้า CPE เพื่อดึงข้อมูลล่าสุด",
  }
];
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input 
                  placeholder="เช่น แจ้งปัญหาการชำระเงิน, สอบถามเรื่อง CPE" 
                  value={subject} 
